...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Point_DataReader
            public class Point_DataReader : DDS.OpenSplice.FooDataReader<Point_, __Point_Marshaler>, 
                                                 IPoint_DataReader
            {
                public Point_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Point_DataWriter
            public class Point_DataWriter : DDS.OpenSplice.FooDataWriter<Point_, __Point_Marshaler>, 
                                                 IPoint_DataWriter
            {
                public Point_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Point_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Point_TypeSupport
            public class Point_TypeSupport : DDS.OpenSplice.TypeSupport
            {
