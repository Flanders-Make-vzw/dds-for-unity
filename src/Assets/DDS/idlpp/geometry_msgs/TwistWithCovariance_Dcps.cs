...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region TwistWithCovariance_DataReader
            public class TwistWithCovariance_DataReader : DDS.OpenSplice.FooDataReader<TwistWithCovariance_, __TwistWithCovariance_Marshaler>, 
                                                 ITwistWithCovariance_DataReader
            {
                public TwistWithCovariance_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TwistWithCovariance_DataWriter
            public class TwistWithCovariance_DataWriter : DDS.OpenSplice.FooDataWriter<TwistWithCovariance_, __TwistWithCovariance_Marshaler>, 
                                                 ITwistWithCovariance_DataWriter
            {
                public TwistWithCovariance_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TwistWithCovariance_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TwistWithCovariance_TypeSupport
            public class TwistWithCovariance_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Double/></Array></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public TwistWithCovariance_TypeSupport()
                    : base(typeof(TwistWithCovariance_), metaDescriptor, "geometry_msgs::msg::dds_::TwistWithCovariance_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TwistWithCovariance_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TwistWithCovariance_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TwistWithCovariance_DataReader(marshaler);
                }
            }
            #endregion
