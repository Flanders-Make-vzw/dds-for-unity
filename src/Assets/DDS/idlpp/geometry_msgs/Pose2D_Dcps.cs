...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Pose2D_DataReader
            public class Pose2D_DataReader : DDS.OpenSplice.FooDataReader<Pose2D_, __Pose2D_Marshaler>, 
                                                 IPose2D_DataReader
            {
                public Pose2D_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Pose2D_DataWriter
            public class Pose2D_DataWriter : DDS.OpenSplice.FooDataWriter<Pose2D_, __Pose2D_Marshaler>, 
                                                 IPose2D_DataWriter
            {
                public Pose2D_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Pose2D_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Pose2D_TypeSupport
            public class Pose2D_TypeSupport : DDS.OpenSplice.TypeSupport
            {
