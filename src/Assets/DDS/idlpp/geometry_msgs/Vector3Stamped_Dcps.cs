...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Vector3Stamped_DataReader
            public class Vector3Stamped_DataReader : DDS.OpenSplice.FooDataReader<Vector3Stamped_, __Vector3Stamped_Marshaler>, 
                                                 IVector3Stamped_DataReader
            {
                public Vector3Stamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Vector3Stamped_DataWriter
            public class Vector3Stamped_DataWriter : DDS.OpenSplice.FooDataWriter<Vector3Stamped_, __Vector3Stamped_Marshaler>, 
                                                 IVector3Stamped_DataWriter
            {
                public Vector3Stamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Vector3Stamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Vector3Stamped_TypeSupport
            public class Vector3Stamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Vector3Stamped_TypeSupport()
                    : base(typeof(Vector3Stamped_), metaDescriptor, "geometry_msgs::msg::dds_::Vector3Stamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Vector3Stamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Vector3Stamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Vector3Stamped_DataReader(marshaler);
                }
            }
            #endregion
