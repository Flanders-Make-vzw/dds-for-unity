...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region TwistStamped_DataReader
            public class TwistStamped_DataReader : DDS.OpenSplice.FooDataReader<TwistStamped_, __TwistStamped_Marshaler>, 
                                                 ITwistStamped_DataReader
            {
                public TwistStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TwistStamped_DataWriter
            public class TwistStamped_DataWriter : DDS.OpenSplice.FooDataWriter<TwistStamped_, __TwistStamped_Marshaler>, 
                                                 ITwistStamped_DataWriter
            {
                public TwistStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TwistStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TwistStamped_TypeSupport
            public class TwistStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</MetaData>"};
                ...
                public TwistStamped_TypeSupport()
                    : base(typeof(TwistStamped_), metaDescriptor, "geometry_msgs::msg::dds_::TwistStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TwistStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TwistStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TwistStamped_DataReader(marshaler);
                }
            }
            #endregion
