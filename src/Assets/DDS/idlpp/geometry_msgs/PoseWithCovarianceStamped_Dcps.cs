...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PoseWithCovarianceStamped_DataReader
            public class PoseWithCovarianceStamped_DataReader : DDS.OpenSplice.FooDataReader<PoseWithCovarianceStamped_, __PoseWithCovarianceStamped_Marshaler>, 
                                                 IPoseWithCovarianceStamped_DataReader
            {
                public PoseWithCovarianceStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PoseWithCovarianceStamped_DataWriter
            public class PoseWithCovarianceStamped_DataWriter : DDS.OpenSplice.FooDataWriter<PoseWithCovarianceStamped_, __PoseWithCovarianceStamped_Marshaler>, 
                                                 IPoseWithCovarianceStamped_DataWriter
            {
                public PoseWithCovarianceStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PoseWithCovarianceStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PoseWithCovarianceStamped_TypeSupport
            public class PoseWithCovarianceStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Type name=\"Pose_\"/></Member><Member name=\"covariance_\"><Array size=\"36\"><Double/></Array></Member>",
"</Struct></Module></Module></Module><Module name=\"builtin_interfaces\"><Module name=\"msg\"><Module name=\"dds_\">",
...
"</Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public PoseWithCovarianceStamped_TypeSupport()
                    : base(typeof(PoseWithCovarianceStamped_), metaDescriptor, "geometry_msgs::msg::dds_::PoseWithCovarianceStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __PoseWithCovarianceStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new PoseWithCovarianceStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new PoseWithCovarianceStamped_DataReader(marshaler);
                }
            }
            #endregion
