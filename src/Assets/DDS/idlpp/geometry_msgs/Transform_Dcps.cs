...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Transform_DataReader
            public class Transform_DataReader : DDS.OpenSplice.FooDataReader<Transform_, __Transform_Marshaler>, 
                                                 ITransform_DataReader
            {
                public Transform_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Transform_DataWriter
            public class Transform_DataWriter : DDS.OpenSplice.FooDataWriter<Transform_, __Transform_Marshaler>, 
                                                 ITransform_DataWriter
            {
                public Transform_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Transform_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Transform_TypeSupport
            public class Transform_TypeSupport : DDS.OpenSplice.TypeSupport
            {
