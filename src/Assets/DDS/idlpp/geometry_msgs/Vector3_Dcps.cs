...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Vector3_DataReader
            public class Vector3_DataReader : DDS.OpenSplice.FooDataReader<Vector3_, __Vector3_Marshaler>, 
                                                 IVector3_DataReader
            {
                public Vector3_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Vector3_DataWriter
            public class Vector3_DataWriter : DDS.OpenSplice.FooDataWriter<Vector3_, __Vector3_Marshaler>, 
                                                 IVector3_DataWriter
            {
                public Vector3_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Vector3_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Vector3_TypeSupport
            public class Vector3_TypeSupport : DDS.OpenSplice.TypeSupport
            {
