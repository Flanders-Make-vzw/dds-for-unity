...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Twist_DataReader
            public class Twist_DataReader : DDS.OpenSplice.FooDataReader<Twist_, __Twist_Marshaler>, 
                                                 ITwist_DataReader
            {
                public Twist_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Twist_DataWriter
            public class Twist_DataWriter : DDS.OpenSplice.FooDataWriter<Twist_, __Twist_Marshaler>, 
                                                 ITwist_DataWriter
            {
                public Twist_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Twist_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Twist_TypeSupport
            public class Twist_TypeSupport : DDS.OpenSplice.TypeSupport
            {
