...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PoseWithCovariance_DataReader
            public class PoseWithCovariance_DataReader : DDS.OpenSplice.FooDataReader<PoseWithCovariance_, __PoseWithCovariance_Marshaler>, 
                                                 IPoseWithCovariance_DataReader
            {
                public PoseWithCovariance_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PoseWithCovariance_DataWriter
            public class PoseWithCovariance_DataWriter : DDS.OpenSplice.FooDataWriter<PoseWithCovariance_, __PoseWithCovariance_Marshaler>, 
                                                 IPoseWithCovariance_DataWriter
            {
                public PoseWithCovariance_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PoseWithCovariance_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PoseWithCovariance_TypeSupport
            public class PoseWithCovariance_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Struct></Module></Module></Module></MetaData>"};
                ...
                public PoseWithCovariance_TypeSupport()
                    : base(typeof(PoseWithCovariance_), metaDescriptor, "geometry_msgs::msg::dds_::PoseWithCovariance_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __PoseWithCovariance_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new PoseWithCovariance_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new PoseWithCovariance_DataReader(marshaler);
                }
            }
            #endregion
