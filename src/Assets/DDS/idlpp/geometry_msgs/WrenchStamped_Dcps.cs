...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region WrenchStamped_DataReader
            public class WrenchStamped_DataReader : DDS.OpenSplice.FooDataReader<WrenchStamped_, __WrenchStamped_Marshaler>, 
                                                 IWrenchStamped_DataReader
            {
                public WrenchStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region WrenchStamped_DataWriter
            public class WrenchStamped_DataWriter : DDS.OpenSplice.FooDataWriter<WrenchStamped_, __WrenchStamped_Marshaler>, 
                                                 IWrenchStamped_DataWriter
            {
                public WrenchStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(WrenchStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region WrenchStamped_TypeSupport
            public class WrenchStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</MetaData>"};
                ...
                public WrenchStamped_TypeSupport()
                    : base(typeof(WrenchStamped_), metaDescriptor, "geometry_msgs::msg::dds_::WrenchStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __WrenchStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new WrenchStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new WrenchStamped_DataReader(marshaler);
                }
            }
            #endregion
