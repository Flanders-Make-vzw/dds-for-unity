...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region QuaternionStamped_DataReader
            public class QuaternionStamped_DataReader : DDS.OpenSplice.FooDataReader<QuaternionStamped_, __QuaternionStamped_Marshaler>, 
                                                 IQuaternionStamped_DataReader
            {
                public QuaternionStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region QuaternionStamped_DataWriter
            public class QuaternionStamped_DataWriter : DDS.OpenSplice.FooDataWriter<QuaternionStamped_, __QuaternionStamped_Marshaler>, 
                                                 IQuaternionStamped_DataWriter
            {
                public QuaternionStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(QuaternionStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region QuaternionStamped_TypeSupport
            public class QuaternionStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Module><Module name=\"builtin_interfaces\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Time_\">",
...
"</Module></MetaData>"};
                ...
                public QuaternionStamped_TypeSupport()
                    : base(typeof(QuaternionStamped_), metaDescriptor, "geometry_msgs::msg::dds_::QuaternionStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __QuaternionStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new QuaternionStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new QuaternionStamped_DataReader(marshaler);
                }
            }
            #endregion
