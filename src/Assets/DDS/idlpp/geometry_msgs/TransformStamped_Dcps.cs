...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region TransformStamped_DataReader
            public class TransformStamped_DataReader : DDS.OpenSplice.FooDataReader<TransformStamped_, __TransformStamped_Marshaler>, 
                                                 ITransformStamped_DataReader
            {
                public TransformStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TransformStamped_DataWriter
            public class TransformStamped_DataWriter : DDS.OpenSplice.FooDataWriter<TransformStamped_, __TransformStamped_Marshaler>, 
                                                 ITransformStamped_DataWriter
            {
                public TransformStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TransformStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TransformStamped_TypeSupport
            public class TransformStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public TransformStamped_TypeSupport()
                    : base(typeof(TransformStamped_), metaDescriptor, "geometry_msgs::msg::dds_::TransformStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TransformStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TransformStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TransformStamped_DataReader(marshaler);
                }
            }
            #endregion
