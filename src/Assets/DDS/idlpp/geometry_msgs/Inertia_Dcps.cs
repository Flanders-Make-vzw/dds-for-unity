...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Inertia_DataReader
            public class Inertia_DataReader : DDS.OpenSplice.FooDataReader<Inertia_, __Inertia_Marshaler>, 
                                                 IInertia_DataReader
            {
                public Inertia_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Inertia_DataWriter
            public class Inertia_DataWriter : DDS.OpenSplice.FooDataWriter<Inertia_, __Inertia_Marshaler>, 
                                                 IInertia_DataWriter
            {
                public Inertia_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Inertia_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Inertia_TypeSupport
            public class Inertia_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Member name=\"z_\"><Double/></Member></Struct><Struct name=\"Inertia_\"><Member name=\"m_\"><Double/>",
"</Member><Member name=\"com_\"><Type name=\"Vector3_\"/></Member><Member name=\"ixx_\"><Double/></Member>",
"<Member name=\"ixy_\"><Double/></Member><Member name=\"ixz_\"><Double/></Member><Member name=\"iyy_\">",
"<Double/></Member><Member name=\"iyz_\"><Double/></Member><Member name=\"izz_\"><Double/></Member></Struct>",
"</Module></Module></Module></MetaData>"};

                public Inertia_TypeSupport()
                    : base(typeof(Inertia_), metaDescriptor, "geometry_msgs::msg::dds_::Inertia_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Inertia_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Inertia_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Inertia_DataReader(marshaler);
                }
            }
            #endregion
