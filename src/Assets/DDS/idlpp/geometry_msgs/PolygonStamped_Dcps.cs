...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PolygonStamped_DataReader
            public class PolygonStamped_DataReader : DDS.OpenSplice.FooDataReader<PolygonStamped_, __PolygonStamped_Marshaler>, 
                                                 IPolygonStamped_DataReader
            {
                public PolygonStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PolygonStamped_DataWriter
            public class PolygonStamped_DataWriter : DDS.OpenSplice.FooDataWriter<PolygonStamped_, __PolygonStamped_Marshaler>, 
                                                 IPolygonStamped_DataWriter
            {
                public PolygonStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PolygonStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PolygonStamped_TypeSupport
            public class PolygonStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Sequence></Member></Struct></Module></Module></Module><Module name=\"builtin_interfaces\"><Module name=\"msg\">",
...
"</Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public PolygonStamped_TypeSupport()
                    : base(typeof(PolygonStamped_), metaDescriptor, "geometry_msgs::msg::dds_::PolygonStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __PolygonStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new PolygonStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new PolygonStamped_DataReader(marshaler);
                }
            }
            #endregion
