...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Quaternion_DataReader
            public class Quaternion_DataReader : DDS.OpenSplice.FooDataReader<Quaternion_, __Quaternion_Marshaler>, 
                                                 IQuaternion_DataReader
            {
                public Quaternion_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Quaternion_DataWriter
            public class Quaternion_DataWriter : DDS.OpenSplice.FooDataWriter<Quaternion_, __Quaternion_Marshaler>, 
                                                 IQuaternion_DataWriter
            {
                public Quaternion_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Quaternion_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Quaternion_TypeSupport
            public class Quaternion_TypeSupport : DDS.OpenSplice.TypeSupport
            {
