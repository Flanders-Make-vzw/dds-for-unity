...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PoseStamped_DataReader
            public class PoseStamped_DataReader : DDS.OpenSplice.FooDataReader<PoseStamped_, __PoseStamped_Marshaler>, 
                                                 IPoseStamped_DataReader
            {
                public PoseStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PoseStamped_DataWriter
            public class PoseStamped_DataWriter : DDS.OpenSplice.FooDataWriter<PoseStamped_, __PoseStamped_Marshaler>, 
                                                 IPoseStamped_DataWriter
            {
                public PoseStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PoseStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PoseStamped_TypeSupport
            public class PoseStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member><Member name=\"pose_\"><Type name=\"Pose_\"/></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public PoseStamped_TypeSupport()
                    : base(typeof(PoseStamped_), metaDescriptor, "geometry_msgs::msg::dds_::PoseStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __PoseStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new PoseStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new PoseStamped_DataReader(marshaler);
                }
            }
            #endregion
