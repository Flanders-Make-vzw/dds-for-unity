...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Polygon_DataReader
            public class Polygon_DataReader : DDS.OpenSplice.FooDataReader<Polygon_, __Polygon_Marshaler>, 
                                                 IPolygon_DataReader
            {
                public Polygon_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Polygon_DataWriter
            public class Polygon_DataWriter : DDS.OpenSplice.FooDataWriter<Polygon_, __Polygon_Marshaler>, 
                                                 IPolygon_DataWriter
            {
                public Polygon_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Polygon_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Polygon_TypeSupport
            public class Polygon_TypeSupport : DDS.OpenSplice.TypeSupport
            {
