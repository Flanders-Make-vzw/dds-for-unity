...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region InertiaStamped_DataReader
            public class InertiaStamped_DataReader : DDS.OpenSplice.FooDataReader<InertiaStamped_, __InertiaStamped_Marshaler>, 
                                                 IInertiaStamped_DataReader
            {
                public InertiaStamped_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region InertiaStamped_DataWriter
            public class InertiaStamped_DataWriter : DDS.OpenSplice.FooDataWriter<InertiaStamped_, __InertiaStamped_Marshaler>, 
                                                 IInertiaStamped_DataWriter
            {
                public InertiaStamped_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(InertiaStamped_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region InertiaStamped_TypeSupport
            public class InertiaStamped_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Module></Module></Module><Module name=\"builtin_interfaces\"><Module name=\"msg\"><Module name=\"dds_\">",
...
"<Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"InertiaStamped_\"><Member name=\"header_\">",
"<Type name=\"::std_msgs::msg::dds_::Header_\"/></Member><Member name=\"inertia_\"><Type name=\"Inertia_\"/>",
"</Member></Struct></Module></Module></Module></MetaData>"};

                public InertiaStamped_TypeSupport()
                    : base(typeof(InertiaStamped_), metaDescriptor, "geometry_msgs::msg::dds_::InertiaStamped_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __InertiaStamped_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new InertiaStamped_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new InertiaStamped_DataReader(marshaler);
                }
            }
            #endregion
