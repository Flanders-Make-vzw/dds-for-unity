...
namespace geometry_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Point32_DataReader
            public class Point32_DataReader : DDS.OpenSplice.FooDataReader<Point32_, __Point32_Marshaler>, 
                                                 IPoint32_DataReader
            {
                public Point32_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Point32_DataWriter
            public class Point32_DataWriter : DDS.OpenSplice.FooDataWriter<Point32_, __Point32_Marshaler>, 
                                                 IPoint32_DataWriter
            {
                public Point32_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Point32_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Point32_TypeSupport
            public class Point32_TypeSupport : DDS.OpenSplice.TypeSupport
            {
