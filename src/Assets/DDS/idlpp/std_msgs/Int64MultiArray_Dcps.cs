...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int64MultiArray_DataReader
            public class Int64MultiArray_DataReader : DDS.OpenSplice.FooDataReader<Int64MultiArray_, __Int64MultiArray_Marshaler>, 
                                                 IInt64MultiArray_DataReader
            {
                public Int64MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int64MultiArray_DataWriter
            public class Int64MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<Int64MultiArray_, __Int64MultiArray_Marshaler>, 
                                                 IInt64MultiArray_DataWriter
            {
                public Int64MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int64MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int64MultiArray_TypeSupport
            public class Int64MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<LongLong/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Int64MultiArray_TypeSupport()
                    : base(typeof(Int64MultiArray_), metaDescriptor, "std_msgs::msg::dds_::Int64MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int64MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int64MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int64MultiArray_DataReader(marshaler);
                }
            }
            #endregion
