...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Float64MultiArray_DataReader
            public class Float64MultiArray_DataReader : DDS.OpenSplice.FooDataReader<Float64MultiArray_, __Float64MultiArray_Marshaler>, 
                                                 IFloat64MultiArray_DataReader
            {
                public Float64MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Float64MultiArray_DataWriter
            public class Float64MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<Float64MultiArray_, __Float64MultiArray_Marshaler>, 
                                                 IFloat64MultiArray_DataWriter
            {
                public Float64MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Float64MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Float64MultiArray_TypeSupport
            public class Float64MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Double/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Float64MultiArray_TypeSupport()
                    : base(typeof(Float64MultiArray_), metaDescriptor, "std_msgs::msg::dds_::Float64MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Float64MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Float64MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Float64MultiArray_DataReader(marshaler);
                }
            }
            #endregion
