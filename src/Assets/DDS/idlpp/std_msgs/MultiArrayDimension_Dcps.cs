...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MultiArrayDimension_DataReader
            public class MultiArrayDimension_DataReader : DDS.OpenSplice.FooDataReader<MultiArrayDimension_, __MultiArrayDimension_Marshaler>, 
                                                 IMultiArrayDimension_DataReader
            {
                public MultiArrayDimension_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MultiArrayDimension_DataWriter
            public class MultiArrayDimension_DataWriter : DDS.OpenSplice.FooDataWriter<MultiArrayDimension_, __MultiArrayDimension_Marshaler>, 
                                                 IMultiArrayDimension_DataWriter
            {
                public MultiArrayDimension_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MultiArrayDimension_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MultiArrayDimension_TypeSupport
            public class MultiArrayDimension_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<ULong/></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public MultiArrayDimension_TypeSupport()
                    : base(typeof(MultiArrayDimension_), metaDescriptor, "std_msgs::msg::dds_::MultiArrayDimension_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MultiArrayDimension_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MultiArrayDimension_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MultiArrayDimension_DataReader(marshaler);
                }
            }
            #endregion
