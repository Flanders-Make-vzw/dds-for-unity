...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt64MultiArray_DataReader
            public class UInt64MultiArray_DataReader : DDS.OpenSplice.FooDataReader<UInt64MultiArray_, __UInt64MultiArray_Marshaler>, 
                                                 IUInt64MultiArray_DataReader
            {
                public UInt64MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt64MultiArray_DataWriter
            public class UInt64MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<UInt64MultiArray_, __UInt64MultiArray_Marshaler>, 
                                                 IUInt64MultiArray_DataWriter
            {
                public UInt64MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt64MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt64MultiArray_TypeSupport
            public class UInt64MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<ULongLong/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public UInt64MultiArray_TypeSupport()
                    : base(typeof(UInt64MultiArray_), metaDescriptor, "std_msgs::msg::dds_::UInt64MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt64MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt64MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt64MultiArray_DataReader(marshaler);
                }
            }
            #endregion
