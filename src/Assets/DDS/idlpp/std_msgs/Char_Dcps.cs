...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Char_DataReader
            public class Char_DataReader : DDS.OpenSplice.FooDataReader<Char_, __Char_Marshaler>, 
                                                 IChar_DataReader
            {
                public Char_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Char_DataWriter
            public class Char_DataWriter : DDS.OpenSplice.FooDataWriter<Char_, __Char_Marshaler>, 
                                                 IChar_DataWriter
            {
                public Char_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Char_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Char_TypeSupport
            public class Char_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Char_\">",
"<Member name=\"data_\"><Octet/></Member></Struct></Module></Module></Module></MetaData>"};

                public Char_TypeSupport()
                    : base(typeof(Char_), metaDescriptor, "std_msgs::msg::dds_::Char_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Char_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Char_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Char_DataReader(marshaler);
                }
            }
            #endregion
