...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region String_DataReader
            public class String_DataReader : DDS.OpenSplice.FooDataReader<String_, __String_Marshaler>, 
                                                 IString_DataReader
            {
                public String_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region String_DataWriter
            public class String_DataWriter : DDS.OpenSplice.FooDataWriter<String_, __String_Marshaler>, 
                                                 IString_DataWriter
            {
                public String_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(String_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region String_TypeSupport
            public class String_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"String_\">",
"<Member name=\"data_\"><String/></Member></Struct></Module></Module></Module></MetaData>"};

                public String_TypeSupport()
                    : base(typeof(String_), metaDescriptor, "std_msgs::msg::dds_::String_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __String_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new String_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new String_DataReader(marshaler);
                }
            }
            #endregion
