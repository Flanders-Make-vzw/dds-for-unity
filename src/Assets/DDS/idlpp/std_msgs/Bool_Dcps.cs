...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Bool_DataReader
            public class Bool_DataReader : DDS.OpenSplice.FooDataReader<Bool_, __Bool_Marshaler>, 
                                                 IBool_DataReader
            {
                public Bool_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Bool_DataWriter
            public class Bool_DataWriter : DDS.OpenSplice.FooDataWriter<Bool_, __Bool_Marshaler>, 
                                                 IBool_DataWriter
            {
                public Bool_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Bool_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Bool_TypeSupport
            public class Bool_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Bool_\">",
"<Member name=\"data_\"><Boolean/></Member></Struct></Module></Module></Module></MetaData>"};

                public Bool_TypeSupport()
                    : base(typeof(Bool_), metaDescriptor, "std_msgs::msg::dds_::Bool_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Bool_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Bool_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Bool_DataReader(marshaler);
                }
            }
            #endregion
