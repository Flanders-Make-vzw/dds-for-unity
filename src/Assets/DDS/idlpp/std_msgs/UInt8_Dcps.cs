...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt8_DataReader
            public class UInt8_DataReader : DDS.OpenSplice.FooDataReader<UInt8_, __UInt8_Marshaler>, 
                                                 IUInt8_DataReader
            {
                public UInt8_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt8_DataWriter
            public class UInt8_DataWriter : DDS.OpenSplice.FooDataWriter<UInt8_, __UInt8_Marshaler>, 
                                                 IUInt8_DataWriter
            {
                public UInt8_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt8_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt8_TypeSupport
            public class UInt8_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"UInt8_\">",
"<Member name=\"data_\"><Octet/></Member></Struct></Module></Module></Module></MetaData>"};

                public UInt8_TypeSupport()
                    : base(typeof(UInt8_), metaDescriptor, "std_msgs::msg::dds_::UInt8_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt8_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt8_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt8_DataReader(marshaler);
                }
            }
            #endregion
