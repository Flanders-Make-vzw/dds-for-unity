...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int64_DataReader
            public class Int64_DataReader : DDS.OpenSplice.FooDataReader<Int64_, __Int64_Marshaler>, 
                                                 IInt64_DataReader
            {
                public Int64_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int64_DataWriter
            public class Int64_DataWriter : DDS.OpenSplice.FooDataWriter<Int64_, __Int64_Marshaler>, 
                                                 IInt64_DataWriter
            {
                public Int64_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int64_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int64_TypeSupport
            public class Int64_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Int64_\">",
"<Member name=\"data_\"><LongLong/></Member></Struct></Module></Module></Module></MetaData>"};

                public Int64_TypeSupport()
                    : base(typeof(Int64_), metaDescriptor, "std_msgs::msg::dds_::Int64_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int64_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int64_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int64_DataReader(marshaler);
                }
            }
            #endregion
