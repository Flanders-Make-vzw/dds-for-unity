...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MultiArrayLayout_DataReader
            public class MultiArrayLayout_DataReader : DDS.OpenSplice.FooDataReader<MultiArrayLayout_, __MultiArrayLayout_Marshaler>, 
                                                 IMultiArrayLayout_DataReader
            {
                public MultiArrayLayout_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MultiArrayLayout_DataWriter
            public class MultiArrayLayout_DataWriter : DDS.OpenSplice.FooDataWriter<MultiArrayLayout_, __MultiArrayLayout_Marshaler>, 
                                                 IMultiArrayLayout_DataWriter
            {
                public MultiArrayLayout_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MultiArrayLayout_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MultiArrayLayout_TypeSupport
            public class MultiArrayLayout_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</MetaData>"};
                ...
                public MultiArrayLayout_TypeSupport()
                    : base(typeof(MultiArrayLayout_), metaDescriptor, "std_msgs::msg::dds_::MultiArrayLayout_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MultiArrayLayout_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MultiArrayLayout_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MultiArrayLayout_DataReader(marshaler);
                }
            }
            #endregion
