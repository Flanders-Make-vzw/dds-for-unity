...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Float32MultiArray_DataReader
            public class Float32MultiArray_DataReader : DDS.OpenSplice.FooDataReader<Float32MultiArray_, __Float32MultiArray_Marshaler>, 
                                                 IFloat32MultiArray_DataReader
            {
                public Float32MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Float32MultiArray_DataWriter
            public class Float32MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<Float32MultiArray_, __Float32MultiArray_Marshaler>, 
                                                 IFloat32MultiArray_DataWriter
            {
                public Float32MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Float32MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Float32MultiArray_TypeSupport
            public class Float32MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Float/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Float32MultiArray_TypeSupport()
                    : base(typeof(Float32MultiArray_), metaDescriptor, "std_msgs::msg::dds_::Float32MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Float32MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Float32MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Float32MultiArray_DataReader(marshaler);
                }
            }
            #endregion
