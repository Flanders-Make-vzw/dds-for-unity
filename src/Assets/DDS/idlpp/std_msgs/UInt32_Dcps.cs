...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt32_DataReader
            public class UInt32_DataReader : DDS.OpenSplice.FooDataReader<UInt32_, __UInt32_Marshaler>, 
                                                 IUInt32_DataReader
            {
                public UInt32_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt32_DataWriter
            public class UInt32_DataWriter : DDS.OpenSplice.FooDataWriter<UInt32_, __UInt32_Marshaler>, 
                                                 IUInt32_DataWriter
            {
                public UInt32_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt32_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt32_TypeSupport
            public class UInt32_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"UInt32_\">",
"<Member name=\"data_\"><ULong/></Member></Struct></Module></Module></Module></MetaData>"};

                public UInt32_TypeSupport()
                    : base(typeof(UInt32_), metaDescriptor, "std_msgs::msg::dds_::UInt32_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt32_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt32_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt32_DataReader(marshaler);
                }
            }
            #endregion
