...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Byte_DataReader
            public class Byte_DataReader : DDS.OpenSplice.FooDataReader<Byte_, __Byte_Marshaler>, 
                                                 IByte_DataReader
            {
                public Byte_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Byte_DataWriter
            public class Byte_DataWriter : DDS.OpenSplice.FooDataWriter<Byte_, __Byte_Marshaler>, 
                                                 IByte_DataWriter
            {
                public Byte_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Byte_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Byte_TypeSupport
            public class Byte_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Byte_\">",
"<Member name=\"data_\"><Octet/></Member></Struct></Module></Module></Module></MetaData>"};

                public Byte_TypeSupport()
                    : base(typeof(Byte_), metaDescriptor, "std_msgs::msg::dds_::Byte_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Byte_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Byte_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Byte_DataReader(marshaler);
                }
            }
            #endregion
