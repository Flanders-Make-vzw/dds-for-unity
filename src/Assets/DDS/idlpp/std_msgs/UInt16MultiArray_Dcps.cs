...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt16MultiArray_DataReader
            public class UInt16MultiArray_DataReader : DDS.OpenSplice.FooDataReader<UInt16MultiArray_, __UInt16MultiArray_Marshaler>, 
                                                 IUInt16MultiArray_DataReader
            {
                public UInt16MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt16MultiArray_DataWriter
            public class UInt16MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<UInt16MultiArray_, __UInt16MultiArray_Marshaler>, 
                                                 IUInt16MultiArray_DataWriter
            {
                public UInt16MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt16MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt16MultiArray_TypeSupport
            public class UInt16MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<UShort/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public UInt16MultiArray_TypeSupport()
                    : base(typeof(UInt16MultiArray_), metaDescriptor, "std_msgs::msg::dds_::UInt16MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt16MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt16MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt16MultiArray_DataReader(marshaler);
                }
            }
            #endregion
