...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int32MultiArray_DataReader
            public class Int32MultiArray_DataReader : DDS.OpenSplice.FooDataReader<Int32MultiArray_, __Int32MultiArray_Marshaler>, 
                                                 IInt32MultiArray_DataReader
            {
                public Int32MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int32MultiArray_DataWriter
            public class Int32MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<Int32MultiArray_, __Int32MultiArray_Marshaler>, 
                                                 IInt32MultiArray_DataWriter
            {
                public Int32MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int32MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int32MultiArray_TypeSupport
            public class Int32MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Long/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Int32MultiArray_TypeSupport()
                    : base(typeof(Int32MultiArray_), metaDescriptor, "std_msgs::msg::dds_::Int32MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int32MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int32MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int32MultiArray_DataReader(marshaler);
                }
            }
            #endregion
