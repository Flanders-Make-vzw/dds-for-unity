...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int8MultiArray_DataReader
            public class Int8MultiArray_DataReader : DDS.OpenSplice.FooDataReader<Int8MultiArray_, __Int8MultiArray_Marshaler>, 
                                                 IInt8MultiArray_DataReader
            {
                public Int8MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int8MultiArray_DataWriter
            public class Int8MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<Int8MultiArray_, __Int8MultiArray_Marshaler>, 
                                                 IInt8MultiArray_DataWriter
            {
                public Int8MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int8MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int8MultiArray_TypeSupport
            public class Int8MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Octet/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public Int8MultiArray_TypeSupport()
                    : base(typeof(Int8MultiArray_), metaDescriptor, "std_msgs::msg::dds_::Int8MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int8MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int8MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int8MultiArray_DataReader(marshaler);
                }
            }
            #endregion
