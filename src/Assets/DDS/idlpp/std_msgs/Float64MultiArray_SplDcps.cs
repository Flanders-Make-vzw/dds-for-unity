...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region __Float64MultiArray_
            [StructLayout(LayoutKind.Sequential)]
            public struct __Float64MultiArray_
            {
            ...
            #region __Float64MultiArray_Marshaler
            public sealed class __Float64MultiArray_Marshaler : DDS.OpenSplice.CustomMarshalers.FooDatabaseMarshaler<std_msgs.msg.dds_.Float64MultiArray_>
            {
                public static readonly string fullyScopedName = "std_msgs::msg::dds_::Float64MultiArray_";
                ...
                public override V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, System.IntPtr from, System.IntPtr to)
                {
                    ...
                    std_msgs.msg.dds_.Float64MultiArray_ fromData = tmpGCHandle.Target as std_msgs.msg.dds_.Float64MultiArray_;
                    return CopyIn(typePtr, fromData, to);
                }

                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Float64MultiArray_ from, System.IntPtr to)
                {
                    __Float64MultiArray_ nativeImg = new __Float64MultiArray_();
                ...
                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Float64MultiArray_ from, ref __Float64MultiArray_ to)
                {
                ...
                {
                    __Float64MultiArray_ nativeImg = (__Float64MultiArray_) Marshal.PtrToStructure(from, typeof(__Float64MultiArray_));
                    GCHandle tmpGCHandleTo = GCHandle.FromIntPtr(to);
                    std_msgs.msg.dds_.Float64MultiArray_ toObj = tmpGCHandleTo.Target as std_msgs.msg.dds_.Float64MultiArray_;
                    CopyOut(ref nativeImg, ref toObj);
                    tmpGCHandleTo.Target = toObj;
                }

                public override void CopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Float64MultiArray_ to)
                {
                    __Float64MultiArray_ nativeImg = (__Float64MultiArray_) Marshal.PtrToStructure(from, typeof(__Float64MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void StaticCopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Float64MultiArray_ to)
                {
                    __Float64MultiArray_ nativeImg = (__Float64MultiArray_) Marshal.PtrToStructure(from, typeof(__Float64MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void CopyOut(ref __Float64MultiArray_ from, ref std_msgs.msg.dds_.Float64MultiArray_ to)
                {
                    if (to == null) {
                        to = new std_msgs.msg.dds_.Float64MultiArray_();
                    }
                    ...
                    if (to.data_ == null || to.data_.Length != attr1Seq0Length) {
                        to.data_ = new double[attr1Seq0Length];
                    }
