...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int8_DataReader
            public class Int8_DataReader : DDS.OpenSplice.FooDataReader<Int8_, __Int8_Marshaler>, 
                                                 IInt8_DataReader
            {
                public Int8_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int8_DataWriter
            public class Int8_DataWriter : DDS.OpenSplice.FooDataWriter<Int8_, __Int8_Marshaler>, 
                                                 IInt8_DataWriter
            {
                public Int8_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int8_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int8_TypeSupport
            public class Int8_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Int8_\">",
"<Member name=\"data_\"><Octet/></Member></Struct></Module></Module></Module></MetaData>"};

                public Int8_TypeSupport()
                    : base(typeof(Int8_), metaDescriptor, "std_msgs::msg::dds_::Int8_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int8_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int8_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int8_DataReader(marshaler);
                }
            }
            #endregion
