...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt32MultiArray_DataReader
            public class UInt32MultiArray_DataReader : DDS.OpenSplice.FooDataReader<UInt32MultiArray_, __UInt32MultiArray_Marshaler>, 
                                                 IUInt32MultiArray_DataReader
            {
                public UInt32MultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt32MultiArray_DataWriter
            public class UInt32MultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<UInt32MultiArray_, __UInt32MultiArray_Marshaler>, 
                                                 IUInt32MultiArray_DataWriter
            {
                public UInt32MultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt32MultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt32MultiArray_TypeSupport
            public class UInt32MultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<ULong/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public UInt32MultiArray_TypeSupport()
                    : base(typeof(UInt32MultiArray_), metaDescriptor, "std_msgs::msg::dds_::UInt32MultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt32MultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt32MultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt32MultiArray_DataReader(marshaler);
                }
            }
            #endregion
