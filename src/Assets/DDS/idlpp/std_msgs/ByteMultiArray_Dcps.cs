...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region ByteMultiArray_DataReader
            public class ByteMultiArray_DataReader : DDS.OpenSplice.FooDataReader<ByteMultiArray_, __ByteMultiArray_Marshaler>, 
                                                 IByteMultiArray_DataReader
            {
                public ByteMultiArray_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region ByteMultiArray_DataWriter
            public class ByteMultiArray_DataWriter : DDS.OpenSplice.FooDataWriter<ByteMultiArray_, __ByteMultiArray_Marshaler>, 
                                                 IByteMultiArray_DataWriter
            {
                public ByteMultiArray_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(ByteMultiArray_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region ByteMultiArray_TypeSupport
            public class ByteMultiArray_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Octet/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public ByteMultiArray_TypeSupport()
                    : base(typeof(ByteMultiArray_), metaDescriptor, "std_msgs::msg::dds_::ByteMultiArray_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __ByteMultiArray_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new ByteMultiArray_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new ByteMultiArray_DataReader(marshaler);
                }
            }
            #endregion
