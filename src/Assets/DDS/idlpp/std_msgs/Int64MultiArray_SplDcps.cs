...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region __Int64MultiArray_
            [StructLayout(LayoutKind.Sequential)]
            public struct __Int64MultiArray_
            {
            ...
            #region __Int64MultiArray_Marshaler
            public sealed class __Int64MultiArray_Marshaler : DDS.OpenSplice.CustomMarshalers.FooDatabaseMarshaler<std_msgs.msg.dds_.Int64MultiArray_>
            {
                public static readonly string fullyScopedName = "std_msgs::msg::dds_::Int64MultiArray_";
                private std_msgs.msg.dds_.__MultiArrayLayout_Marshaler attr0Marshaler;
                private IntPtr attr1Col0Type = IntPtr.Zero;
                private static readonly int attr1Col0Size = 1 * Marshal.SizeOf(typeof(long));
                ...
                public override V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, System.IntPtr from, System.IntPtr to)
                {
                    ...
                    std_msgs.msg.dds_.Int64MultiArray_ fromData = tmpGCHandle.Target as std_msgs.msg.dds_.Int64MultiArray_;
                    return CopyIn(typePtr, fromData, to);
                }

                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Int64MultiArray_ from, System.IntPtr to)
                {
                    __Int64MultiArray_ nativeImg = new __Int64MultiArray_();
                ...
                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Int64MultiArray_ from, ref __Int64MultiArray_ to)
                {
                ...
                {
                    __Int64MultiArray_ nativeImg = (__Int64MultiArray_) Marshal.PtrToStructure(from, typeof(__Int64MultiArray_));
                    GCHandle tmpGCHandleTo = GCHandle.FromIntPtr(to);
                    std_msgs.msg.dds_.Int64MultiArray_ toObj = tmpGCHandleTo.Target as std_msgs.msg.dds_.Int64MultiArray_;
                    CopyOut(ref nativeImg, ref toObj);
                    tmpGCHandleTo.Target = toObj;
                }

                public override void CopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Int64MultiArray_ to)
                {
                    __Int64MultiArray_ nativeImg = (__Int64MultiArray_) Marshal.PtrToStructure(from, typeof(__Int64MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void StaticCopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Int64MultiArray_ to)
                {
                    __Int64MultiArray_ nativeImg = (__Int64MultiArray_) Marshal.PtrToStructure(from, typeof(__Int64MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void CopyOut(ref __Int64MultiArray_ from, ref std_msgs.msg.dds_.Int64MultiArray_ to)
                {
                    if (to == null) {
                        to = new std_msgs.msg.dds_.Int64MultiArray_();
                    }
                    ...
                    if (to.data_ == null || to.data_.Length != attr1Seq0Length) {
                        to.data_ = new long[attr1Seq0Length];
                    }
