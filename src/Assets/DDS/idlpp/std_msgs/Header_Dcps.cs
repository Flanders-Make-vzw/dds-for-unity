...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Header_DataReader
            public class Header_DataReader : DDS.OpenSplice.FooDataReader<Header_, __Header_Marshaler>, 
                                                 IHeader_DataReader
            {
                public Header_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Header_DataWriter
            public class Header_DataWriter : DDS.OpenSplice.FooDataWriter<Header_, __Header_Marshaler>, 
                                                 IHeader_DataWriter
            {
                public Header_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Header_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Header_TypeSupport
            public class Header_TypeSupport : DDS.OpenSplice.TypeSupport
            {
