...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Int32_DataReader
            public class Int32_DataReader : DDS.OpenSplice.FooDataReader<Int32_, __Int32_Marshaler>, 
                                                 IInt32_DataReader
            {
                public Int32_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Int32_DataWriter
            public class Int32_DataWriter : DDS.OpenSplice.FooDataWriter<Int32_, __Int32_Marshaler>, 
                                                 IInt32_DataWriter
            {
                public Int32_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Int32_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Int32_TypeSupport
            public class Int32_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Int32_\">",
"<Member name=\"data_\"><Long/></Member></Struct></Module></Module></Module></MetaData>"};

                public Int32_TypeSupport()
                    : base(typeof(Int32_), metaDescriptor, "std_msgs::msg::dds_::Int32_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Int32_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Int32_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Int32_DataReader(marshaler);
                }
            }
            #endregion
