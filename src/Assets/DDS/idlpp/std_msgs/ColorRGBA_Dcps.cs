...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region ColorRGBA_DataReader
            public class ColorRGBA_DataReader : DDS.OpenSplice.FooDataReader<ColorRGBA_, __ColorRGBA_Marshaler>, 
                                                 IColorRGBA_DataReader
            {
                public ColorRGBA_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region ColorRGBA_DataWriter
            public class ColorRGBA_DataWriter : DDS.OpenSplice.FooDataWriter<ColorRGBA_, __ColorRGBA_Marshaler>, 
                                                 IColorRGBA_DataWriter
            {
                public ColorRGBA_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(ColorRGBA_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region ColorRGBA_TypeSupport
            public class ColorRGBA_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"ColorRGBA_\">",
