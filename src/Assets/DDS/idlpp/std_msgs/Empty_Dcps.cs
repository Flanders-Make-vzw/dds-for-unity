...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Empty_DataReader
            public class Empty_DataReader : DDS.OpenSplice.FooDataReader<Empty_, __Empty_Marshaler>, 
                                                 IEmpty_DataReader
            {
                public Empty_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Empty_DataWriter
            public class Empty_DataWriter : DDS.OpenSplice.FooDataWriter<Empty_, __Empty_Marshaler>, 
                                                 IEmpty_DataWriter
            {
                public Empty_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Empty_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Empty_TypeSupport
            public class Empty_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Empty_\">",
"<Member name=\"structure_needs_at_least_one_member_\"><Octet/></Member></Struct></Module></Module></Module>",
"</MetaData>"};

                public Empty_TypeSupport()
                    : base(typeof(Empty_), metaDescriptor, "std_msgs::msg::dds_::Empty_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Empty_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Empty_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Empty_DataReader(marshaler);
                }
            }
            #endregion
