...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region UInt16_DataReader
            public class UInt16_DataReader : DDS.OpenSplice.FooDataReader<UInt16_, __UInt16_Marshaler>, 
                                                 IUInt16_DataReader
            {
                public UInt16_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region UInt16_DataWriter
            public class UInt16_DataWriter : DDS.OpenSplice.FooDataWriter<UInt16_, __UInt16_Marshaler>, 
                                                 IUInt16_DataWriter
            {
                public UInt16_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(UInt16_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region UInt16_TypeSupport
            public class UInt16_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"std_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"UInt16_\">",
"<Member name=\"data_\"><UShort/></Member></Struct></Module></Module></Module></MetaData>"};

                public UInt16_TypeSupport()
                    : base(typeof(UInt16_), metaDescriptor, "std_msgs::msg::dds_::UInt16_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __UInt16_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new UInt16_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new UInt16_DataReader(marshaler);
                }
            }
            #endregion
