...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region __Float32MultiArray_
            [StructLayout(LayoutKind.Sequential)]
            public struct __Float32MultiArray_
            {
            ...
            #region __Float32MultiArray_Marshaler
            public sealed class __Float32MultiArray_Marshaler : DDS.OpenSplice.CustomMarshalers.FooDatabaseMarshaler<std_msgs.msg.dds_.Float32MultiArray_>
            {
                public static readonly string fullyScopedName = "std_msgs::msg::dds_::Float32MultiArray_";
                ...
                public override V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, System.IntPtr from, System.IntPtr to)
                {
                    ...
                    std_msgs.msg.dds_.Float32MultiArray_ fromData = tmpGCHandle.Target as std_msgs.msg.dds_.Float32MultiArray_;
                    return CopyIn(typePtr, fromData, to);
                }

                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Float32MultiArray_ from, System.IntPtr to)
                {
                    __Float32MultiArray_ nativeImg = new __Float32MultiArray_();
                ...
                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Float32MultiArray_ from, ref __Float32MultiArray_ to)
                {
                ...
                {
                    __Float32MultiArray_ nativeImg = (__Float32MultiArray_) Marshal.PtrToStructure(from, typeof(__Float32MultiArray_));
                    GCHandle tmpGCHandleTo = GCHandle.FromIntPtr(to);
                    std_msgs.msg.dds_.Float32MultiArray_ toObj = tmpGCHandleTo.Target as std_msgs.msg.dds_.Float32MultiArray_;
                    CopyOut(ref nativeImg, ref toObj);
                    tmpGCHandleTo.Target = toObj;
                }

                public override void CopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Float32MultiArray_ to)
                {
                    __Float32MultiArray_ nativeImg = (__Float32MultiArray_) Marshal.PtrToStructure(from, typeof(__Float32MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void StaticCopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Float32MultiArray_ to)
                {
                    __Float32MultiArray_ nativeImg = (__Float32MultiArray_) Marshal.PtrToStructure(from, typeof(__Float32MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void CopyOut(ref __Float32MultiArray_ from, ref std_msgs.msg.dds_.Float32MultiArray_ to)
                {
                    if (to == null) {
                        to = new std_msgs.msg.dds_.Float32MultiArray_();
                    }
                    ...
                    if (to.data_ == null || to.data_.Length != attr1Seq0Length) {
                        to.data_ = new float[attr1Seq0Length];
                    }
