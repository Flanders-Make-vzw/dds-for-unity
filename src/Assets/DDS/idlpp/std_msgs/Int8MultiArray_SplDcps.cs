...
namespace std_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region __Int8MultiArray_
            [StructLayout(LayoutKind.Sequential)]
            public struct __Int8MultiArray_
            {
            ...
            #region __Int8MultiArray_Marshaler
            public sealed class __Int8MultiArray_Marshaler : DDS.OpenSplice.CustomMarshalers.FooDatabaseMarshaler<std_msgs.msg.dds_.Int8MultiArray_>
            {
                public static readonly string fullyScopedName = "std_msgs::msg::dds_::Int8MultiArray_";
                ...
                public override V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, System.IntPtr from, System.IntPtr to)
                {
                    ...
                    std_msgs.msg.dds_.Int8MultiArray_ fromData = tmpGCHandle.Target as std_msgs.msg.dds_.Int8MultiArray_;
                    return CopyIn(typePtr, fromData, to);
                }

                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Int8MultiArray_ from, System.IntPtr to)
                {
                    __Int8MultiArray_ nativeImg = new __Int8MultiArray_();
                ...
                public V_COPYIN_RESULT CopyIn(System.IntPtr typePtr, std_msgs.msg.dds_.Int8MultiArray_ from, ref __Int8MultiArray_ to)
                {
                ...
                {
                    __Int8MultiArray_ nativeImg = (__Int8MultiArray_) Marshal.PtrToStructure(from, typeof(__Int8MultiArray_));
                    GCHandle tmpGCHandleTo = GCHandle.FromIntPtr(to);
                    std_msgs.msg.dds_.Int8MultiArray_ toObj = tmpGCHandleTo.Target as std_msgs.msg.dds_.Int8MultiArray_;
                    CopyOut(ref nativeImg, ref toObj);
                    tmpGCHandleTo.Target = toObj;
                }

                public override void CopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Int8MultiArray_ to)
                {
                    __Int8MultiArray_ nativeImg = (__Int8MultiArray_) Marshal.PtrToStructure(from, typeof(__Int8MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void StaticCopyOut(System.IntPtr from, ref std_msgs.msg.dds_.Int8MultiArray_ to)
                {
                    __Int8MultiArray_ nativeImg = (__Int8MultiArray_) Marshal.PtrToStructure(from, typeof(__Int8MultiArray_));
                    CopyOut(ref nativeImg, ref to);
                }

                public static void CopyOut(ref __Int8MultiArray_ from, ref std_msgs.msg.dds_.Int8MultiArray_ to)
                {
                    if (to == null) {
                        to = new std_msgs.msg.dds_.Int8MultiArray_();
                    }
