...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MagneticField_DataReader
            public class MagneticField_DataReader : DDS.OpenSplice.FooDataReader<MagneticField_, __MagneticField_Marshaler>, 
                                                 IMagneticField_DataReader
            {
                public MagneticField_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MagneticField_DataWriter
            public class MagneticField_DataWriter : DDS.OpenSplice.FooDataWriter<MagneticField_, __MagneticField_Marshaler>, 
                                                 IMagneticField_DataWriter
            {
                public MagneticField_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MagneticField_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MagneticField_TypeSupport
            public class MagneticField_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Member name=\"z_\"><Double/></Member></Struct></Module></Module></Module><Module name=\"builtin_interfaces\">",
...
"<Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"MagneticField_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
"</Member><Member name=\"magnetic_field_\"><Type name=\"::geometry_msgs::msg::dds_::Vector3_\"/></Member>",
"<Member name=\"magnetic_field_covariance_\"><Array size=\"9\"><Double/></Array></Member></Struct></Module>",
"</Module></Module></MetaData>"};

                public MagneticField_TypeSupport()
                    : base(typeof(MagneticField_), metaDescriptor, "sensor_msgs::msg::dds_::MagneticField_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MagneticField_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MagneticField_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MagneticField_DataReader(marshaler);
                }
            }
            #endregion
