...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region ChannelFloat32_DataReader
            public class ChannelFloat32_DataReader : DDS.OpenSplice.FooDataReader<ChannelFloat32_, __ChannelFloat32_Marshaler>, 
                                                 IChannelFloat32_DataReader
            {
                public ChannelFloat32_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region ChannelFloat32_DataWriter
            public class ChannelFloat32_DataWriter : DDS.OpenSplice.FooDataWriter<ChannelFloat32_, __ChannelFloat32_Marshaler>, 
                                                 IChannelFloat32_DataWriter
            {
                public ChannelFloat32_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(ChannelFloat32_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region ChannelFloat32_TypeSupport
            public class ChannelFloat32_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Struct></Module></Module></Module></MetaData>"};
                ...
                public ChannelFloat32_TypeSupport()
                    : base(typeof(ChannelFloat32_), metaDescriptor, "sensor_msgs::msg::dds_::ChannelFloat32_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __ChannelFloat32_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new ChannelFloat32_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new ChannelFloat32_DataReader(marshaler);
                }
            }
            #endregion
