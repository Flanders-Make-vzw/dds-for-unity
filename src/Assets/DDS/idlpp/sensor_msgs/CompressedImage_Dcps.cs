...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region CompressedImage_DataReader
            public class CompressedImage_DataReader : DDS.OpenSplice.FooDataReader<CompressedImage_, __CompressedImage_Marshaler>, 
                                                 ICompressedImage_DataReader
            {
                public CompressedImage_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region CompressedImage_DataWriter
            public class CompressedImage_DataWriter : DDS.OpenSplice.FooDataWriter<CompressedImage_, __CompressedImage_Marshaler>, 
                                                 ICompressedImage_DataWriter
            {
                public CompressedImage_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(CompressedImage_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region CompressedImage_TypeSupport
            public class CompressedImage_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Sequence><Octet/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public CompressedImage_TypeSupport()
                    : base(typeof(CompressedImage_), metaDescriptor, "sensor_msgs::msg::dds_::CompressedImage_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __CompressedImage_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new CompressedImage_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new CompressedImage_DataReader(marshaler);
                }
            }
            #endregion
