...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region TimeReference_DataReader
            public class TimeReference_DataReader : DDS.OpenSplice.FooDataReader<TimeReference_, __TimeReference_Marshaler>, 
                                                 ITimeReference_DataReader
            {
                public TimeReference_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TimeReference_DataWriter
            public class TimeReference_DataWriter : DDS.OpenSplice.FooDataWriter<TimeReference_, __TimeReference_Marshaler>, 
                                                 ITimeReference_DataWriter
            {
                public TimeReference_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TimeReference_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TimeReference_TypeSupport
            public class TimeReference_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member><Member name=\"time_ref_\"><Type name=\"::builtin_interfaces::msg::dds_::Time_\"/></Member><Member name=\"source_\">",
"<String/></Member></Struct></Module></Module></Module></MetaData>"};

                public TimeReference_TypeSupport()
                    : base(typeof(TimeReference_), metaDescriptor, "sensor_msgs::msg::dds_::TimeReference_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TimeReference_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TimeReference_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TimeReference_DataReader(marshaler);
                }
            }
            #endregion
