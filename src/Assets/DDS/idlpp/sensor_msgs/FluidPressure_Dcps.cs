...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region FluidPressure_DataReader
            public class FluidPressure_DataReader : DDS.OpenSplice.FooDataReader<FluidPressure_, __FluidPressure_Marshaler>, 
                                                 IFluidPressure_DataReader
            {
                public FluidPressure_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region FluidPressure_DataWriter
            public class FluidPressure_DataWriter : DDS.OpenSplice.FooDataWriter<FluidPressure_, __FluidPressure_Marshaler>, 
                                                 IFluidPressure_DataWriter
            {
                public FluidPressure_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(FluidPressure_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region FluidPressure_TypeSupport
            public class FluidPressure_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Struct></Module></Module></Module></MetaData>"};
                ...
                public FluidPressure_TypeSupport()
                    : base(typeof(FluidPressure_), metaDescriptor, "sensor_msgs::msg::dds_::FluidPressure_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __FluidPressure_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new FluidPressure_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new FluidPressure_DataReader(marshaler);
                }
            }
            #endregion
