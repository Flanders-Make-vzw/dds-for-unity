...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Temperature_DataReader
            public class Temperature_DataReader : DDS.OpenSplice.FooDataReader<Temperature_, __Temperature_Marshaler>, 
                                                 ITemperature_DataReader
            {
                public Temperature_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Temperature_DataWriter
            public class Temperature_DataWriter : DDS.OpenSplice.FooDataWriter<Temperature_, __Temperature_Marshaler>, 
                                                 ITemperature_DataWriter
            {
                public Temperature_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Temperature_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Temperature_TypeSupport
            public class Temperature_TypeSupport : DDS.OpenSplice.TypeSupport
            {
