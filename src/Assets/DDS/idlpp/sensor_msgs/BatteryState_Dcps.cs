...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            ...
            #region BatteryState_DataReader
            public class BatteryState_DataReader : DDS.OpenSplice.FooDataReader<BatteryState_, __BatteryState_Marshaler>, 
                                                 IBatteryState_DataReader
            {
                public BatteryState_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region BatteryState_DataWriter
            public class BatteryState_DataWriter : DDS.OpenSplice.FooDataWriter<BatteryState_, __BatteryState_Marshaler>, 
                                                 IBatteryState_DataWriter
            {
                public BatteryState_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(BatteryState_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region BatteryState_TypeSupport
            public class BatteryState_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"BatteryState_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
"</Member><Member name=\"voltage_\"><Float/></Member><Member name=\"temperature_\"><Float/></Member><Member name=\"current_\">",
"<Float/></Member><Member name=\"charge_\"><Float/></Member><Member name=\"capacity_\"><Float/></Member>",
"<Member name=\"design_capacity_\"><Float/></Member><Member name=\"percentage_\"><Float/></Member><Member name=\"power_supply_status_\">",
"<Octet/></Member><Member name=\"power_supply_health_\"><Octet/></Member><Member name=\"power_supply_technology_\">",
"<Octet/></Member><Member name=\"present_\"><Boolean/></Member><Member name=\"cell_voltage_\"><Sequence>",
"<Float/></Sequence></Member><Member name=\"cell_temperature_\"><Sequence><Float/></Sequence></Member>",
"<Member name=\"location_\"><String/></Member><Member name=\"serial_number_\"><String/></Member></Struct>",
"</Module></Module></Module></MetaData>"};

                public BatteryState_TypeSupport()
                    : base(typeof(BatteryState_), metaDescriptor, "sensor_msgs::msg::dds_::BatteryState_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __BatteryState_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new BatteryState_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new BatteryState_DataReader(marshaler);
                }
            }
            #endregion
