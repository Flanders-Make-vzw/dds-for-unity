...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PointCloud_DataReader
            public class PointCloud_DataReader : DDS.OpenSplice.FooDataReader<PointCloud_, __PointCloud_Marshaler>, 
                                                 IPointCloud_DataReader
            {
                public PointCloud_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PointCloud_DataWriter
            public class PointCloud_DataWriter : DDS.OpenSplice.FooDataWriter<PointCloud_, __PointCloud_Marshaler>, 
                                                 IPointCloud_DataWriter
            {
                public PointCloud_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PointCloud_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PointCloud_TypeSupport
            public class PointCloud_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"sensor_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"ChannelFloat32_\">",
...
"<Float/></Member></Struct></Module></Module></Module><Module name=\"builtin_interfaces\"><Module name=\"msg\">",
