...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Image_DataReader
            public class Image_DataReader : DDS.OpenSplice.FooDataReader<Image_, __Image_Marshaler>, 
                                                 IImage_DataReader
            {
                public Image_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Image_DataWriter
            public class Image_DataWriter : DDS.OpenSplice.FooDataWriter<Image_, __Image_Marshaler>, 
                                                 IImage_DataWriter
            {
                public Image_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Image_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Image_TypeSupport
            public class Image_TypeSupport : DDS.OpenSplice.TypeSupport
            {
