...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            ...
            #region NavSatFix_DataReader
            public class NavSatFix_DataReader : DDS.OpenSplice.FooDataReader<NavSatFix_, __NavSatFix_Marshaler>, 
                                                 INavSatFix_DataReader
            {
                public NavSatFix_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region NavSatFix_DataWriter
            public class NavSatFix_DataWriter : DDS.OpenSplice.FooDataWriter<NavSatFix_, __NavSatFix_Marshaler>, 
                                                 INavSatFix_DataWriter
            {
                public NavSatFix_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(NavSatFix_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region NavSatFix_TypeSupport
            public class NavSatFix_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Module></Module><Module name=\"builtin_interfaces\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Time_\">",
...
"<Module name=\"dds_\"><Struct name=\"NavSatFix_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
...
"<Array size=\"9\"><Double/></Array></Member><Member name=\"position_covariance_type_\"><Octet/></Member>",
"</Struct></Module></Module></Module></MetaData>"};

                public NavSatFix_TypeSupport()
                    : base(typeof(NavSatFix_), metaDescriptor, "sensor_msgs::msg::dds_::NavSatFix_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __NavSatFix_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new NavSatFix_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new NavSatFix_DataReader(marshaler);
                }
            }
            #endregion
