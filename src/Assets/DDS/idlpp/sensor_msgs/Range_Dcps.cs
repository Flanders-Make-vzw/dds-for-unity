...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            ...
            #region Range_DataReader
            public class Range_DataReader : DDS.OpenSplice.FooDataReader<Range_, __Range_Marshaler>, 
                                                 IRange_DataReader
            {
                public Range_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Range_DataWriter
            public class Range_DataWriter : DDS.OpenSplice.FooDataWriter<Range_, __Range_Marshaler>, 
                                                 IRange_DataWriter
            {
                public Range_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Range_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Range_TypeSupport
            public class Range_TypeSupport : DDS.OpenSplice.TypeSupport
            {
