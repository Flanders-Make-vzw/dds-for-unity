...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region RegionOfInterest_DataReader
            public class RegionOfInterest_DataReader : DDS.OpenSplice.FooDataReader<RegionOfInterest_, __RegionOfInterest_Marshaler>, 
                                                 IRegionOfInterest_DataReader
            {
                public RegionOfInterest_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region RegionOfInterest_DataWriter
            public class RegionOfInterest_DataWriter : DDS.OpenSplice.FooDataWriter<RegionOfInterest_, __RegionOfInterest_Marshaler>, 
                                                 IRegionOfInterest_DataWriter
            {
                public RegionOfInterest_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(RegionOfInterest_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region RegionOfInterest_TypeSupport
            public class RegionOfInterest_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Struct></Module></Module></Module></MetaData>"};
                ...
                public RegionOfInterest_TypeSupport()
                    : base(typeof(RegionOfInterest_), metaDescriptor, "sensor_msgs::msg::dds_::RegionOfInterest_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __RegionOfInterest_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new RegionOfInterest_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new RegionOfInterest_DataReader(marshaler);
                }
            }
            #endregion
