...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region JointState_DataReader
            public class JointState_DataReader : DDS.OpenSplice.FooDataReader<JointState_, __JointState_Marshaler>, 
                                                 IJointState_DataReader
            {
                public JointState_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region JointState_DataWriter
            public class JointState_DataWriter : DDS.OpenSplice.FooDataWriter<JointState_, __JointState_Marshaler>, 
                                                 IJointState_DataWriter
            {
                public JointState_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(JointState_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region JointState_TypeSupport
            public class JointState_TypeSupport : DDS.OpenSplice.TypeSupport
            {
