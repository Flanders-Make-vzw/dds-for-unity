...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region PointCloud2_DataReader
            public class PointCloud2_DataReader : DDS.OpenSplice.FooDataReader<PointCloud2_, __PointCloud2_Marshaler>, 
                                                 IPointCloud2_DataReader
            {
                public PointCloud2_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region PointCloud2_DataWriter
            public class PointCloud2_DataWriter : DDS.OpenSplice.FooDataWriter<PointCloud2_, __PointCloud2_Marshaler>, 
                                                 IPointCloud2_DataWriter
            {
                public PointCloud2_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(PointCloud2_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region PointCloud2_TypeSupport
            public class PointCloud2_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"sensor_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"PointField_\">",
"<Member name=\"name_\"><String/></Member><Member name=\"offset_\"><ULong/></Member><Member name=\"datatype_\">",
"<Octet/></Member><Member name=\"count_\"><ULong/></Member></Struct></Module></Module></Module><Module name=\"builtin_interfaces\">",
...
"<Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"PointCloud2_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
