...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Illuminance_DataReader
            public class Illuminance_DataReader : DDS.OpenSplice.FooDataReader<Illuminance_, __Illuminance_Marshaler>, 
                                                 IIlluminance_DataReader
            {
                public Illuminance_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Illuminance_DataWriter
            public class Illuminance_DataWriter : DDS.OpenSplice.FooDataWriter<Illuminance_, __Illuminance_Marshaler>, 
                                                 IIlluminance_DataWriter
            {
                public Illuminance_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Illuminance_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Illuminance_TypeSupport
            public class Illuminance_TypeSupport : DDS.OpenSplice.TypeSupport
            {
