...
namespace sensor_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region CameraInfo_DataReader
            public class CameraInfo_DataReader : DDS.OpenSplice.FooDataReader<CameraInfo_, __CameraInfo_Marshaler>, 
                                                 ICameraInfo_DataReader
            {
                public CameraInfo_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region CameraInfo_DataWriter
            public class CameraInfo_DataWriter : DDS.OpenSplice.FooDataWriter<CameraInfo_, __CameraInfo_Marshaler>, 
                                                 ICameraInfo_DataWriter
            {
                public CameraInfo_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(CameraInfo_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region CameraInfo_TypeSupport
            public class CameraInfo_TypeSupport : DDS.OpenSplice.TypeSupport
            {
