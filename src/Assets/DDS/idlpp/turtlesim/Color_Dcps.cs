...
namespace turtlesim
{
    namespace msg
    {
        namespace dds_
        {
            #region Color_DataReader
            public class Color_DataReader : DDS.OpenSplice.FooDataReader<Color_, __Color_Marshaler>, 
                                                 IColor_DataReader
            {
                public Color_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Color_DataWriter
            public class Color_DataWriter : DDS.OpenSplice.FooDataWriter<Color_, __Color_Marshaler>, 
                                                 IColor_DataWriter
            {
                public Color_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Color_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Color_TypeSupport
            public class Color_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"turtlesim\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Color_\">",
"<Member name=\"r_\"><Octet/></Member><Member name=\"g_\"><Octet/></Member><Member name=\"b_\"><Octet/>",
"</Member></Struct></Module></Module></Module></MetaData>"};

                public Color_TypeSupport()
                    : base(typeof(Color_), metaDescriptor, "turtlesim::msg::dds_::Color_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __Color_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new Color_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new Color_DataReader(marshaler);
                }
            }
            #endregion
