...
namespace turtlesim
{
    namespace msg
    {
        namespace dds_
        {
            #region Pose_DataReader
            public class Pose_DataReader : DDS.OpenSplice.FooDataReader<Pose_, __Pose_Marshaler>, 
                                                 IPose_DataReader
            {
                public Pose_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Pose_DataWriter
            public class Pose_DataWriter : DDS.OpenSplice.FooDataWriter<Pose_, __Pose_Marshaler>, 
                                                 IPose_DataWriter
            {
                public Pose_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Pose_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Pose_TypeSupport
            public class Pose_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"turtlesim\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Pose_\">",
