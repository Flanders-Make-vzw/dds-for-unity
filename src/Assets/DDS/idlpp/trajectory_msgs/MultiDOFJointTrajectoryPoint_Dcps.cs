...
namespace trajectory_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MultiDOFJointTrajectoryPoint_DataReader
            public class MultiDOFJointTrajectoryPoint_DataReader : DDS.OpenSplice.FooDataReader<MultiDOFJointTrajectoryPoint_, __MultiDOFJointTrajectoryPoint_Marshaler>, 
                                                 IMultiDOFJointTrajectoryPoint_DataReader
            {
                public MultiDOFJointTrajectoryPoint_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MultiDOFJointTrajectoryPoint_DataWriter
            public class MultiDOFJointTrajectoryPoint_DataWriter : DDS.OpenSplice.FooDataWriter<MultiDOFJointTrajectoryPoint_, __MultiDOFJointTrajectoryPoint_Marshaler>, 
                                                 IMultiDOFJointTrajectoryPoint_DataWriter
            {
                public MultiDOFJointTrajectoryPoint_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MultiDOFJointTrajectoryPoint_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MultiDOFJointTrajectoryPoint_TypeSupport
            public class MultiDOFJointTrajectoryPoint_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Module name=\"dds_\"><Struct name=\"Duration_\"><Member name=\"sec_\"><Long/></Member><Member name=\"nanosec_\">",
...
"</MetaData>"};
                ...
                public MultiDOFJointTrajectoryPoint_TypeSupport()
                    : base(typeof(MultiDOFJointTrajectoryPoint_), metaDescriptor, "trajectory_msgs::msg::dds_::MultiDOFJointTrajectoryPoint_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MultiDOFJointTrajectoryPoint_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MultiDOFJointTrajectoryPoint_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MultiDOFJointTrajectoryPoint_DataReader(marshaler);
                }
            }
            #endregion
