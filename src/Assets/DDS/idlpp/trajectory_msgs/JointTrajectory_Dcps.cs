...
namespace trajectory_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region JointTrajectory_DataReader
            public class JointTrajectory_DataReader : DDS.OpenSplice.FooDataReader<JointTrajectory_, __JointTrajectory_Marshaler>, 
                                                 IJointTrajectory_DataReader
            {
                public JointTrajectory_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region JointTrajectory_DataWriter
            public class JointTrajectory_DataWriter : DDS.OpenSplice.FooDataWriter<JointTrajectory_, __JointTrajectory_Marshaler>, 
                                                 IJointTrajectory_DataWriter
            {
                public JointTrajectory_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(JointTrajectory_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region JointTrajectory_TypeSupport
            public class JointTrajectory_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</MetaData>"};
                ...
                public JointTrajectory_TypeSupport()
                    : base(typeof(JointTrajectory_), metaDescriptor, "trajectory_msgs::msg::dds_::JointTrajectory_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __JointTrajectory_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new JointTrajectory_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new JointTrajectory_DataReader(marshaler);
                }
            }
            #endregion
