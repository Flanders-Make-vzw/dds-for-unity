...
namespace trajectory_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region JointTrajectoryPoint_DataReader
            public class JointTrajectoryPoint_DataReader : DDS.OpenSplice.FooDataReader<JointTrajectoryPoint_, __JointTrajectoryPoint_Marshaler>, 
                                                 IJointTrajectoryPoint_DataReader
            {
                public JointTrajectoryPoint_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region JointTrajectoryPoint_DataWriter
            public class JointTrajectoryPoint_DataWriter : DDS.OpenSplice.FooDataWriter<JointTrajectoryPoint_, __JointTrajectoryPoint_Marshaler>, 
                                                 IJointTrajectoryPoint_DataWriter
            {
                public JointTrajectoryPoint_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(JointTrajectoryPoint_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region JointTrajectoryPoint_TypeSupport
            public class JointTrajectoryPoint_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</MetaData>"};
                ...
                public JointTrajectoryPoint_TypeSupport()
                    : base(typeof(JointTrajectoryPoint_), metaDescriptor, "trajectory_msgs::msg::dds_::JointTrajectoryPoint_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __JointTrajectoryPoint_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new JointTrajectoryPoint_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new JointTrajectoryPoint_DataReader(marshaler);
                }
            }
            #endregion
