...
namespace tf2_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region TFMessage_DataReader
            public class TFMessage_DataReader : DDS.OpenSplice.FooDataReader<TFMessage_, __TFMessage_Marshaler>, 
                                                 ITFMessage_DataReader
            {
                public TFMessage_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TFMessage_DataWriter
            public class TFMessage_DataWriter : DDS.OpenSplice.FooDataWriter<TFMessage_, __TFMessage_Marshaler>, 
                                                 ITFMessage_DataWriter
            {
                public TFMessage_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TFMessage_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TFMessage_TypeSupport
            public class TFMessage_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member></Struct></Module></Module></Module><Module name=\"tf2_msgs\"><Module name=\"msg\"><Module name=\"dds_\">",
"<Struct name=\"TFMessage_\"><Member name=\"transforms_\"><Sequence><Type name=\"::geometry_msgs::msg::dds_::TransformStamped_\"/>",
"</Sequence></Member></Struct></Module></Module></Module></MetaData>"};

                public TFMessage_TypeSupport()
                    : base(typeof(TFMessage_), metaDescriptor, "tf2_msgs::msg::dds_::TFMessage_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TFMessage_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TFMessage_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TFMessage_DataReader(marshaler);
                }
            }
            #endregion
