...
namespace tf2_msgs
{
    namespace msg
    {
        namespace dds_
        {
            ...
            #region TF2Error_DataReader
            public class TF2Error_DataReader : DDS.OpenSplice.FooDataReader<TF2Error_, __TF2Error_Marshaler>, 
                                                 ITF2Error_DataReader
            {
                public TF2Error_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region TF2Error_DataWriter
            public class TF2Error_DataWriter : DDS.OpenSplice.FooDataWriter<TF2Error_, __TF2Error_Marshaler>, 
                                                 ITF2Error_DataWriter
            {
                public TF2Error_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(TF2Error_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region TF2Error_TypeSupport
            public class TF2Error_TypeSupport : DDS.OpenSplice.TypeSupport
            {
                private static readonly string[] metaDescriptor = {"<MetaData version=\"1.0.0\"><Module name=\"tf2_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"TF2Error_\">",
"<Member name=\"error_\"><Octet/></Member><Member name=\"error_string_\"><String/></Member></Struct></Module>",
"</Module></Module></MetaData>"};

                public TF2Error_TypeSupport()
                    : base(typeof(TF2Error_), metaDescriptor, "tf2_msgs::msg::dds_::TF2Error_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __TF2Error_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new TF2Error_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new TF2Error_DataReader(marshaler);
                }
            }
            #endregion
