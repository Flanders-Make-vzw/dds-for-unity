...
namespace planner_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MotionPlanResponse_DataReader
            public class MotionPlanResponse_DataReader : DDS.OpenSplice.FooDataReader<MotionPlanResponse_, __MotionPlanResponse_Marshaler>, 
                                                 IMotionPlanResponse_DataReader
            {
                public MotionPlanResponse_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MotionPlanResponse_DataWriter
            public class MotionPlanResponse_DataWriter : DDS.OpenSplice.FooDataWriter<MotionPlanResponse_, __MotionPlanResponse_Marshaler>, 
                                                 IMotionPlanResponse_DataWriter
            {
                public MotionPlanResponse_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MotionPlanResponse_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MotionPlanResponse_TypeSupport
            public class MotionPlanResponse_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Struct><Struct name=\"Duration_\"><Member name=\"sec_\"><Long/></Member><Member name=\"nanosec_\"><ULong/>",
"</Member></Struct></Module></Module></Module><Module name=\"trajectory_msgs\"><Module name=\"msg\"><Module name=\"dds_\">",
"<Struct name=\"JointTrajectoryPoint_\"><Member name=\"positions_\"><Sequence><Double/></Sequence></Member>",
"<Member name=\"velocities_\"><Sequence><Double/></Sequence></Member><Member name=\"accelerations_\"><Sequence>",
"<Double/></Sequence></Member><Member name=\"effort_\"><Sequence><Double/></Sequence></Member><Member name=\"time_from_start_\">",
...
"<Struct name=\"JointTrajectory_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
"</Member><Member name=\"joint_names_\"><Sequence><String/></Sequence></Member><Member name=\"points_\">",
"<Sequence><Type name=\"JointTrajectoryPoint_\"/></Sequence></Member></Struct></Module></Module></Module>",
"<Module name=\"planner_msgs\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"MotionPlanResponse_\">",
"<Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/></Member><Member name=\"plan_id_\">",
"<String/></Member><Member name=\"start_trajectory_\"><Type name=\"::trajectory_msgs::msg::dds_::JointTrajectory_\"/>",
"</Member><Member name=\"path_trajectory_\"><Type name=\"::trajectory_msgs::msg::dds_::JointTrajectory_\"/>",
"</Member></Struct></Module></Module></Module></MetaData>"};

                public MotionPlanResponse_TypeSupport()
                    : base(typeof(MotionPlanResponse_), metaDescriptor, "planner_msgs::msg::dds_::MotionPlanResponse_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MotionPlanResponse_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MotionPlanResponse_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MotionPlanResponse_DataReader(marshaler);
                }
            }
            #endregion
