...
namespace planner_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MotionPlanRequest_DataReader
            public class MotionPlanRequest_DataReader : DDS.OpenSplice.FooDataReader<MotionPlanRequest_, __MotionPlanRequest_Marshaler>, 
                                                 IMotionPlanRequest_DataReader
            {
                public MotionPlanRequest_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MotionPlanRequest_DataWriter
            public class MotionPlanRequest_DataWriter : DDS.OpenSplice.FooDataWriter<MotionPlanRequest_, __MotionPlanRequest_Marshaler>, 
                                                 IMotionPlanRequest_DataWriter
            {
                public MotionPlanRequest_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MotionPlanRequest_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MotionPlanRequest_TypeSupport
            public class MotionPlanRequest_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"</Member></Struct></Module></Module></Module><Module name=\"planner_msgs\"><Module name=\"msg\"><Module name=\"dds_\">",
"<Struct name=\"MotionPlanRequest_\"><Member name=\"header_\"><Type name=\"::std_msgs::msg::dds_::Header_\"/>",
"</Member><Member name=\"plan_id_\"><String/></Member><Member name=\"path_\"><Type name=\"::nav_msgs::msg::dds_::Path_\"/>",
"</Member></Struct></Module></Module></Module></MetaData>"};

                public MotionPlanRequest_TypeSupport()
                    : base(typeof(MotionPlanRequest_), metaDescriptor, "planner_msgs::msg::dds_::MotionPlanRequest_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MotionPlanRequest_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MotionPlanRequest_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MotionPlanRequest_DataReader(marshaler);
                }
            }
            #endregion
