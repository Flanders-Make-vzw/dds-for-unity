...
namespace nav_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Path_DataReader
            public class Path_DataReader : DDS.OpenSplice.FooDataReader<Path_, __Path_Marshaler>, 
                                                 IPath_DataReader
            {
                public Path_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Path_DataWriter
            public class Path_DataWriter : DDS.OpenSplice.FooDataWriter<Path_, __Path_Marshaler>, 
                                                 IPath_DataWriter
            {
                public Path_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Path_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Path_TypeSupport
            public class Path_TypeSupport : DDS.OpenSplice.TypeSupport
            {
