...
namespace nav_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region Odometry_DataReader
            public class Odometry_DataReader : DDS.OpenSplice.FooDataReader<Odometry_, __Odometry_Marshaler>, 
                                                 IOdometry_DataReader
            {
                public Odometry_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region Odometry_DataWriter
            public class Odometry_DataWriter : DDS.OpenSplice.FooDataWriter<Odometry_, __Odometry_Marshaler>, 
                                                 IOdometry_DataWriter
            {
                public Odometry_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(Odometry_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region Odometry_TypeSupport
            public class Odometry_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Member name=\"z_\"><Double/></Member></Struct><Struct name=\"Pose_\"><Member name=\"position_\"><Type name=\"Point_\"/>",
...
"<Member name=\"covariance_\"><Array size=\"36\"><Double/></Array></Member></Struct><Struct name=\"TwistWithCovariance_\">",
