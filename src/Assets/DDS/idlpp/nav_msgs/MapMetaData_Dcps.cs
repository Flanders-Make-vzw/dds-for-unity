...
namespace nav_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region MapMetaData_DataReader
            public class MapMetaData_DataReader : DDS.OpenSplice.FooDataReader<MapMetaData_, __MapMetaData_Marshaler>, 
                                                 IMapMetaData_DataReader
            {
                public MapMetaData_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region MapMetaData_DataWriter
            public class MapMetaData_DataWriter : DDS.OpenSplice.FooDataWriter<MapMetaData_, __MapMetaData_Marshaler>, 
                                                 IMapMetaData_DataWriter
            {
                public MapMetaData_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(MapMetaData_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region MapMetaData_TypeSupport
            public class MapMetaData_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Member name=\"nanosec_\"><ULong/></Member></Struct></Module></Module></Module><Module name=\"nav_msgs\">",
"<Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"MapMetaData_\"><Member name=\"map_load_time_\">",
"<Type name=\"::builtin_interfaces::msg::dds_::Time_\"/></Member><Member name=\"resolution_\"><Float/>",
"</Member><Member name=\"width_\"><ULong/></Member><Member name=\"height_\"><ULong/></Member><Member name=\"origin_\">",
"<Type name=\"::geometry_msgs::msg::dds_::Pose_\"/></Member></Struct></Module></Module></Module></MetaData>"};

                public MapMetaData_TypeSupport()
                    : base(typeof(MapMetaData_), metaDescriptor, "nav_msgs::msg::dds_::MapMetaData_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __MapMetaData_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new MapMetaData_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new MapMetaData_DataReader(marshaler);
                }
            }
            #endregion
