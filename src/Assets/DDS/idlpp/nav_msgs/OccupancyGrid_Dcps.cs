...
namespace nav_msgs
{
    namespace msg
    {
        namespace dds_
        {
            #region OccupancyGrid_DataReader
            public class OccupancyGrid_DataReader : DDS.OpenSplice.FooDataReader<OccupancyGrid_, __OccupancyGrid_Marshaler>, 
                                                 IOccupancyGrid_DataReader
            {
                public OccupancyGrid_DataReader(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
            ...
            #region OccupancyGrid_DataWriter
            public class OccupancyGrid_DataWriter : DDS.OpenSplice.FooDataWriter<OccupancyGrid_, __OccupancyGrid_Marshaler>, 
                                                 IOccupancyGrid_DataWriter
            {
                public OccupancyGrid_DataWriter(DatabaseMarshaler marshaler)
                    : base(marshaler) { }
                ...
                public ReturnCode Write(OccupancyGrid_ instanceData)
                {
                    return base.Write(
                            instanceData,
                            InstanceHandle.Nil,
            ...
            #region OccupancyGrid_TypeSupport
            public class OccupancyGrid_TypeSupport : DDS.OpenSplice.TypeSupport
            {
...
"<Octet/></Sequence></Member></Struct></Module></Module></Module></MetaData>"};
                ...
                public OccupancyGrid_TypeSupport()
                    : base(typeof(OccupancyGrid_), metaDescriptor, "nav_msgs::msg::dds_::OccupancyGrid_", "", "")
                { }


                public override ReturnCode RegisterType(IDomainParticipant participant, string typeName)
                {
                    return RegisterType(participant, typeName, new __OccupancyGrid_Marshaler());
                }

                public override DDS.OpenSplice.DataWriter CreateDataWriter(DatabaseMarshaler marshaler)
                {
                    return new OccupancyGrid_DataWriter(marshaler);
                }

                public override DDS.OpenSplice.DataReader CreateDataReader(DatabaseMarshaler marshaler)
                {
                    return new OccupancyGrid_DataReader(marshaler);
                }
            }
            #endregion
